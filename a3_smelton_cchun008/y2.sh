...
cp M2 M3
echo -n "Hello my friend, this is a reply from Chak Pong, also the end of the conversation" >> M3
echo "" >> M3
...
rm *.tar
tar -cf cchun008_zli.tar  README  M1.base64  M1Sig.base64    M2.base64  M2Sig.base64    M3.base64  M3Sig.base64
